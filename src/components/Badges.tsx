...
const BadgeOrange = ({ value }: Props) => {
  return (
    <>
      <span className="inline-flex items-center gap-x-1.5 rounded-md bg-orange-100 px-2 py-1 text-xs font-medium text-orange-800">
        <svg
          viewBox="0 0 6 6"
          aria-hidden="true"
          className="size-1.5 fill-yellow-500"
