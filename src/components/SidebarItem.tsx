            ...
            <li key={name} className="mt-auto">
                <NavLink to={href}
                         className={({ isActive }) => {
                             ...
                             return isActive ? 'bg-blue-600 text-white group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold' : 'text-indigo-200 hover:bg-blue-600 hover:text-white group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold';
                         }}
                >
