    ...
    <>
      <div className="px-8">
        ...
        <form
          ...
          className={`${tabs[0].current ? '' : 'hidden'}`}
        >
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button
              type="submit"
              className="rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100"
        ...
        <form
          id="update-password"
          className={`${tabs[1].current ? '' : 'hidden'}`}
        >
          <div className="space-y-12 mt-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
              <div>
        ...
        <div
          id="payment-methods"
          className={`${tabs[2].current ? '' : 'hidden'}`}
        >
              ...
              <div className="sm:flex sm:items-start sm:justify-between">
                <div>
                  ...
                  <div className="mt-2 max-w-xl text-sm text-gray-500">
                    <p>
                      Add your payment method to easily manage transactions and
                      enjoy a seamless experience with your subscription.{' '}
                    </p>
                  </div>
                </div>
