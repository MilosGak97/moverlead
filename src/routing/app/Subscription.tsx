...
import {BadgeBlue, BadgeGreen, BadgePink, BadgePurple, BadgeYellow} from "./components/Badges.tsx";
...
const Subscription = () => {
    ...
    const listings: Item[] = [
        { id: "325325325", county: "Atlantic County", state: "New Jersey", status: "Available", price: "25", tier: "1 - List"},
        { id: "325323825", county: "Bergen County", state: "New Jersey",  status: "Available", price: "35", tier: "1 - List" },
        { id: "3252324325", county: "Burlington County", state: "New Jersey",  status: "Subscribed", price: "18", tier: "1 - List" },
    ];
                ...
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        ...
                        <p className="mt-2 text-sm text-gray-700">
                            A list of all counties that are on the market for property listings subscription.
                        </p>
                    </div>
                            ...
                            <div className="relative">
                                ...
                                <table className="min-w-full table-fixed divide-y divide-gray-300">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"
                                            className="py-3.5 pr-3 text-left text-sm font-semibold text-gray-900">County
                                        </th>
                                        <th scope="col"
                                            className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">State
                                        </th>
                                        <th scope="col"
                                        ...
                                        <th scope="col"
                                            className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Tier
                                        </th>
                                    </tr>
                                    </thead>
                                    ...
                                    {listings.map((item) => (
                                        <tr key={item.id}
                                            className={selectedListings.includes(item.id) ? 'bg-gray-50' : undefined}>
                                            <td className="relative px-7 sm:w-12 sm:px-6">
                                                <input
                                                    type="checkbox"
                                                    className="absolute left-4 top-1/2 -mt-2 h-4 w-4"
                                                    checked={selectedListings.includes(item.id)}
                                                    onChange={(e) => toggleIndividual(item.id, e.target.checked)}
                                                />
                                            </td>
                                            <td className="whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900">{item.county}</td>
