...
const variantStyles = {
  solid: {
    ...
    blue: 'bg-[#4379F2] text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-[#4379F2] disabled:bg-blue-200 ',
    white:
